...
const Profile = () => {
  ...
  const handleUpdate = async ()=>{
      try{
          const response = await axiosPrivate.put(`/user/${id}`,{
            nom,prenom,email,cin,age
  ...
  useEffect(() => {
    console.log("Username state updated:", nom);
  }, [nom]);
                  ...
                  <div className="card-profile-image">
                    <a href="#pablo" onClick={(e) => e.preventDefault()}>
                      <img
                        ...
                        src={require("../../assets/img/theme/avatar2.png")}
                      />
                    </a>
                  </div>
                </Col>
              ...
              <CardBody className="pt-0 pt-md-4">
                ...
                <div className="text-center">
                  ...
                  <div className="h5 mt-4">
                    ...
                    {isEmployee ? "Employe" : "Responsable"}
                  </div>
